...
import { deletarReceita } from "../controllers/deletarReceita.controller.js";
...
// Rota deletando Receita:
const rotaDeletandoReceita = Router();
rotaDeletandoReceita.delete('/receitas/:idDeletar', deletarReceita);
